"""
ds-forecasting-day-ahead-markets-cv-pipeline file for ensuring the package
is executable  as `ds-forecasting-day-ahead-markets-cv-pipeline` and
`python -m basic_namespace`
"""
import importlib
